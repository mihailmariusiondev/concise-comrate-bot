...
// Bot messages
export const START_MESSAGE = "Qué pasa crackovich, vamos a resumir tus chats de mierda";
export const NOT_STARTED_MESSAGE = "El bot no está iniciado. Usa */start* para iniciar el bot.";
